...
{
  //nja-std::cout << "MuonCSCChamberResidual::addResidual 1" << std::endl;
  DetId id = hit->geographicalId();
  //nja-std::cout << "MuonCSCChamberResidual::addResidual 2" << std::endl;
  const CSCGeometry *cscGeometry = dynamic_cast<const CSCGeometry*>(m_globalGeometry->slaveGeometry(id));
  //nja-std::cout << "MuonCSCChamberResidual::addResidual 3" << std::endl;
  assert(cscGeometry);
  ...
  std::cout << "     nja                hit->localPosition() y: " <<  hit->localPosition().y() << " tsos->localPosition() y: " << tsos->localPosition().y() << std::endl;
...
//  align::LocalPoint tsosChamberPos = tsos->localPosition();
  ...
  //nja-std::cout << " MuonCSCChamberResidual residual: " << residual << std::endl;
