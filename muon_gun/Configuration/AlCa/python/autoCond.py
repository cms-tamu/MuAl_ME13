autoCond = { 
    ...
    'mc'                :   'MC_53_V14::All',
    # nja - made change here as a hack, so change it back to MC_53_V14 when done
    'mcDESIGN'                :   'DESIGN53_V14::All',
...
autoCond['mc_GRun']     = ( autoCond['mc'], ) \
                             + conditions_L1_Run2012D

autoCond['mc_DESIGN']     = ( autoCond['mcDESIGN'], ) \
                             + conditions_L1_Run2012D
